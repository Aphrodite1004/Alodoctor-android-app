...
import 'package:flutter_patient/screen/Contact.dart';
      ...
      child: Center(
        child: Column(
          ...
          children: <Widget>[
                    ...
                    child: Container(
                        ...
                        decoration: new BoxDecoration(
                            ...
                            image: new DecorationImage(
                                fit: BoxFit.cover,
                                image: new NetworkImage(APIEndPoints.mediaurl + Configs.umodel.photo.toString(),)))),
                  ),
                  Container(
                    child: Container(
                ...
                child: FlatButton(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Image.asset('assets/images/ic_payment_side.png',
                        width: Configs.calcheight(40),
                        height: Configs.calcheight(40),)
                    ],
                  ),
            ...
            Container(
              margin: EdgeInsets.only(top: Configs.calcheight(200)),
